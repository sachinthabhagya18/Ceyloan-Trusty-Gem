...
function re_submit(pid) {
    ...
    r.onreadystatechange = function() {
        if (r.readyState == 4) {
            ...
            if (text == "1") {
                ...
                swal({
                    title: "Alert!",
                    text: "You did not buy this item",
                    icon: "error",
                    button: "Ok",
                });
            } else {
    ...
    r.open("POST", "re_submit.php", true);
    r.send(form);
}

function gotoproduct() {
    swal("Alert!", "Can't currently access this option", "error");
}
...
function showdata(p) {
    ...
    r.open("GET", "shop_content.php?p=" + p, true);
    r.send();
}
...
function m(p) {
    ...
    r.open("GET", "blog448628.php?p=" + p, true);
    r.send();
}
...
function addlike(id) {
    ...
    r.open("GET", "likeprocess.php?id=" + id, true);
    r.send();
}
...
function addunlike(id) {
    ...
    r.open("GET", "unlikeprocess.php?id=" + id, true);
    r.send();

}

function advanceSearch(p) {
    ...
    r.open("POST", "shop_sort.php", true);
    r.send(f);
...
function m2(p) {
    ...
    r.onreadystatechange = function() {
        if (r.readyState == 4) {
            ...
            var d = document.getElementById("best");
            d.innerHTML = text;
        }
    };

    r.open("GET", "Auctionview.php?p=" + p, true);
    r.send();
}