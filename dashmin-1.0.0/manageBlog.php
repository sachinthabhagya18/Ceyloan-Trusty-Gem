...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-75">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="manageBlog.php" class="dropdown-item active">Manage Blog</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
            ...
            $productrs = Database::search("SELECT * FROM `blog` ");
            ...
            $selectedrs = Database::search("SELECT * FROM blog INNER JOIN blog_img ON blog_img.blog_id=blog.id LIMIT " . $result_per_page . " OFFSET " . $page_first_result . " ");
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0 text-center">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col">Paragraph 01</th>
                                    <th scope="col">Paragraph 02</th>
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <img src="<?php echo $srow["img_path"]; ?>" style="height: 60px;"></td>
                                        <td><?php echo $srow["paragraph1"]; ?></td>
                                        <td><?php echo $srow["paragraph2"]; ?></td>
                                        <td><?php echo $srow["note"]; ?></td>
                                        <td><?php echo $srow["blogdate"]; ?></td>
                                        <td><a class="btn btn-sm btn-primary mx-1 mb-1" onclick="sendid(<?php echo $srow['blog_id']; ?>);">Update</a>
                                            <?php
                                            $s = $srow["status_id"];
                                            if ($s == "1") {
                                            ?>
                                                <button class="btn btn-sm  btn-danger" onclick="blockproduct('<?php echo $srow['blog_id']; ?>');">Block</button>
                                            <?php
                                            } else {
                                            ?>
                                                <button class="btn btn-sm  btn-success" onclick="blockproduct('<?php echo $srow['blog_id']; ?>');">Unblock</button>
                                            <?php
                                            }
                                            ?>
