                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4 row">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <textarea placeholder="Paragraph 01" class="form-control" name="" id="p1" cols="15" rows="5"></textarea>
                            </div>
                            <div class="mb-3 col-6">
                                <label for="exampleInputEmail1" class="form-label">paragraph 02</label>
                                <textarea placeholder="Paragraph 02" class="form-control" name="" id="p2" cols="15" rows="5"></textarea>
                            </div>
                            <div class="mb-3 col-6">
                                <label for="exampleInputEmail1" class="form-label">Note</label>
                                <textarea placeholder="Note" class="form-control" name="" id="note" cols="15" rows="5"></textarea>
                            </div>
                            <!-- product img -->
                            ...
                            <!-- product img -->
                            <button class="btn btn-primary" onclick="addBlock();">Add Blog</button>
                        </div>
                    </div>
                </div>
            </div>
