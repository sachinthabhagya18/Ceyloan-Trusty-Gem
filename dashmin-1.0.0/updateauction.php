                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-4 row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-12 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-10">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader5" value="<?php echo $product["path4"]  ?>" />
                                ...
                                <!-- product img -->
                                <button class="btn btn-primary" onclick="updateproductau('<?php echo $product['auction_id']; ?>');">Update Item</button>
                            </div>
                        </div>
                    </div>
                </div>
