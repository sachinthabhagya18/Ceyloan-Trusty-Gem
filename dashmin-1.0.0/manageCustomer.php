...
<head>
    <meta charset="utf-8">
    <title>CTG Manage Customer</title>
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-75">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-user me-1"></i>Customer</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="manageCustomer.php" class="dropdown-item active">Manage Customer</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
            ...
            INNER JOIN profile_img ON profile_img.user_id=`user`.id ORDER BY user.id DESC LIMIT " . $result_per_page . " OFFSET " . $page_first_result . " ");
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td onclick="singleviewmodal('<?php echo $srow['user_id']; ?>');"><?php echo $c; ?>
                                            <img src="../<?php echo $srow["img_path"]; ?>" style="height: 60px; margin-left: 80px;">
                                        </td>

                                        <td> <?php echo $srow['fname'] . ' ' . $srow['lname']; ?>
                                            <br>
                                        ...
                                        <td>
                                            <?php
                                            $s = $srow["user_status_id"];
                                            if ($s == "1") {
                                            ?>
                                                <button class="btn btn-sm  btn-danger" onclick="blockcustomer('<?php echo $srow['user_id']; ?>');">Block</button>
                                            <?php
                                            } else {
                                            ?>
                                                <button class="btn btn-sm  btn-success" onclick="blockcustomer('<?php echo $srow['user_id']; ?>');">Unblock</button>
                                            <?php
                                            }
                                            ?>
