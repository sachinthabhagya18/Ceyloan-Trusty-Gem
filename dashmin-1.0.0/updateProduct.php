...
?>
    ...
    <head>
        <meta charset="utf-8">
        <title>CTG Update Product</title>
                        ...
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-4 row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" class="form-control" id="title" aria-describedby="emailHelp" value="<?php echo $product["title"]  ?>">
                                    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.
                                    </div>
                                </div>
                                <div class="mb-3 col-6">
                                    <label class="form-label">Qty</label>
                                    <input type="number" class="form-control" id="qty" value="<?php echo $product["qty"]  ?>">
                                </div>
                                <div class="mb-3 col-6">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <textarea class="form-control" name="" id="des" cols="15" rows="5" value=""><?php echo $product["description"]  ?></textarea>
                                </div>
                                <div class="mb-3 col-6">
                                <label class="form-label">* Youtube Video Link</label>
                                <input type="text" class="form-control" id="link" placeholder="Link" value="<?php echo $product["video_path"]  ?>">
                            </div>
                                <!-- product img -->
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-6 col-md-2">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev" src="<?php echo $product["path1"]  ?>" />
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-12 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-10">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader" value="<?php echo $product["path1"]  ?>" />
                                                ...
                                                <div class="col-6 col-md-2">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev2" src="<?php echo $product["path2"]  ?>" />
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-10 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader2" value="<?php echo $product["path2"]  ?>" />
                                                ...
                                                <div class="col-6 col-md-2">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev3" src="<?php echo $product["path3"]  ?>" />
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-12 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-10">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader3" value="<?php echo $product["path3"]  ?>" />
                                                ...
                                                <div class="col-6 col-md-2">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev4" src="<?php echo $product["path4"]  ?>" />
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-12 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-10">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader4" value="<?php echo $product["path4"]  ?>" />
                                                ...
                                                <div class="col-6 col-md-2">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev5" src="<?php echo $product["path5"]  ?>" />
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-12 mt-2">
                                                                <div class="row">
                                                                    <div class="col-12 col-lg-12">
                                                                        <input class="d-none" type="file" accept="img/*" id="imguploader5" value="<?php echo $product["path5"]  ?>" />
                                                                        <label class="btn btn-primary col-4 col-lg-12" for="imguploader5" onclick="changeImage5();">Upload QR Only</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <!-- product img -->
                                <button class="btn btn-primary" onclick="updateproduct('<?php echo $product['product_id']; ?>');">Update Item</button>
                            </div>
                        </div>
                    </div>
                </div>
