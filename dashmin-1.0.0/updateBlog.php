                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-4 row">
                                ...
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">paragraph 01</label>
                                    <textarea class="form-control" name="" id="p1" cols="15" rows="5"><?php echo $product["paragraph1"]  ?></textarea>
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">paragraph 02</label>
                                    <textarea class="form-control" name="" id="p2" cols="15" rows="5"><?php echo $product["paragraph2"]  ?></textarea>
                                </div>
                                <div class="mb-3 col-6">
                                    <label for="exampleInputEmail1" class="form-label">Note</label>
                                    <textarea class="form-control" name="" id="note" cols="15" rows="5"><?php echo $product["note"]  ?></textarea>
                                </div>
                                <!-- product img -->
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label lbl1">Add Block Image</label>
                                            <p class="text-danger">* Please add 825 x 580 pixel images </p>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">

                                                <div class="col-12 col-md-4">
                                                    <img class="col-12 col-lg-12 ms-2 img-thumbnail" id="prev" src="<?php echo $product["img_path"] ?>" />
                                ...
                                <!-- product img -->
                                <button class="btn btn-primary" onclick="updateBlog('<?php echo $product['blog_id']; ?>');">Update Blog</button>
                            </div>
                        </div>
                    </div>
                </div>
