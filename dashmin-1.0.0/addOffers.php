                    ...
                    <div class="row g-4">
                        <div class="col-sm-12 col-xl-12">
                            <div class="bg-light rounded h-100 p-4 row">
                                ...
                                $address = Database::search("SELECT * FROM product_offers INNER JOIN product ON product_offers.product_id=product.id
                                INNER JOIN product_item ON product_item.product_id=product.id WHERE product.id='" . $id . "'  ");
                                $n = $address->num_rows;
                                ...
                                ?>
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $d["title"] ?>" disabled>
                                    </div>
                                    <div class="mb-3 col-6">
                                        <label class="form-label">Amount</label>
                                        <input type="text" class="form-control" id="amount" value="<?php echo $d["amount"] ?>">
                                    </div>
                                    <div class="mb-3 col-6">
                                        <label for="exampleInputEmail1" class="form-label">Description</label>
                                        <textarea class="form-control" name="" id="des" cols="15" rows="5" value=""><?php echo $d["discription"]  ?></textarea>
                                    </div>
                                <?php
                                } else {
                                ?>
                                    ...
                                    <div class="mb-3 col-6">
                                        <label class="form-label">Price of Offer</label>
                                        <input type="text" class="form-control" id="amount">
                                    </div>
                                    <div class="mb-3 col-6">
                                        <label for="exampleInputEmail1" class="form-label">Description</label>
                                        <textarea class="form-control" name="" id="des" cols="15" rows="5" value=""></textarea>
                                    </div>
                                <?php
                                }
                                ?>
                                <button class="btn btn-primary" onclick="addOffer('<?php echo $id; ?>');">Add | Update Offers</button>
