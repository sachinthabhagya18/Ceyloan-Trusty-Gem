                        ...
                        <div class="email-rightbar mb-3">
                            ...
                            <div class="card">
                                ...
                                <ul class="message-list">
                                    <?php
                                    // msg data 
                                    $message_rs = Database::search("SELECT * FROM `contact`");
                                    $messaage_n = $message_rs->num_rows;

                                    for ($x = 0; $x < $messaage_n; $x++) {
                                        $messaage_data = $message_rs->fetch_assoc();
                                    ?>
                                        <li onclick="readmail(<?php echo $messaage_data['id']; ?>)">
                                            <div class="col-mail col-mail-1">
                                                <div class="checkbox-wrapper-mail">
                                                    <input type="checkbox" id="<?php echo $messaage_data["id"] ?>">
                                                    <label class="form-label" for="<?php echo $messaage_data["id"] ?>" class="toggle"></label>
                                                </div>
                                                <a href="#" class="title"><?php echo $messaage_data["name"] ?></a><span class="star-toggle far fa-star"></span>
                                            </div>
                                            <div class="col-mail col-mail-2">
                                                <a href="#" class="subject"><span class="teaser"><?php echo $messaage_data["msg"] ?></span>
                                                </a>
                                                <div class="date"><?php echo $messaage_data["date"] ?></div>
                                            </div>
                                        </li>
                                    <?php
                                    }
                            ...
                            <div class="row">
                                <div class="col-7">
                                    Showing 1 - 20 of <?php echo $mcount; ?>
                                </div>
                                <div class="col-5">
