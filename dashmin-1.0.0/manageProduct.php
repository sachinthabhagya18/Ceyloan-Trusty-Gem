...
<head>
    <meta charset="utf-8">
    <title>CTG Manage Product</title>
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            INNER JOIN product_img ON product_img.product_item_id=product_item.id ORDER BY product.id DESC  LIMIT " . $result_per_page . " OFFSET " . $page_first_result . " ");
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $s = $srow["product_status_id"];
                                            if ($s == "1") {
                                            ?>
                                                <button class="btn btn-sm  btn-danger" onclick="blockproduct('<?php echo $srow['product_id']; ?>');">Block</button>
                                            <?php
                                            } else {
                                            ?>
                                                <button class="btn btn-sm  btn-success" onclick="blockproduct('<?php echo $srow['product_id']; ?>');">Unblock</button>
                                            <?php
                                            }
                                            ?>

                                        </td>
                                        <td><a class="btn btn-sm btn-primary mx-1" onclick="sendid(<?php echo $srow['product_id']; ?>);">Update</a>
                                            <a class="btn btn-sm btn-primary mx-1" onclick="sendid3(<?php echo $srow['product_id']; ?>);">Add Auction</a>
                                            <a class="btn btn-sm btn-primary" onclick="sendid2(<?php echo $srow['product_id']; ?>);">Offers</a>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <div class="modal fade" id="singleproductview<?php echo $srow['product_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-center">
                                                    <img src="<?php echo $icode["path1"]; ?>" style="height: 150px;" class="img-fluid">
                                                </div>
